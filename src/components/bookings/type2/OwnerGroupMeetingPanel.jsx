        ...
        {loadingGroups ? (
          ...
          <div className="group-meeting-owner-list">
            {groups.map((group) => {
              ...
              const selectedDateLabel = selectedOption?.date ? formatLongDate(selectedOption.date) : '';
              ...
              return (
                <article className="group-meeting-owner-card" key={group._id}>
                  <div className="dashboard-event-head">
                    ...
                    <span className={`dashboard-badge${group.status === 'finalized' ? ' dashboard-badge-muted' : ''}`}>
                      {group.status === 'finalized' ? 'Finalized' : 'Voting'}
                    </span>
                  </div>
                  ...
                  {group.status === 'finalized' && selectedOption ? (
