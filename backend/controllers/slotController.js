...
/*changed this to return all owners instead of only those with active slots
the previous approach filtered through Slot, which meant new owners with no slots wouldn't show up
this ensures they can still be found on the student side (Sterlande Herard)
*/
